...
public class PesquisarLivro extends javax.swing.JDialog {

    private final List<Livro> listaLivro = new ArrayList<>();
    private final List<Livro> listaEmprestimo = new ArrayList<>();
    private final List<Livro> listaVenda = new ArrayList<>();
    ...
    public PesquisarLivro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void atualizarTabela() {
        ...
        listaLivro.addAll(controle.pegarNome(txtPesquisar.getText()));
        ...
        for (Livro l : listaLivro) {
            ...
            if (l.isSituacao()) {
                if (this.tipo == 0) {
                    ...
                    if (l.getTipo().equals("E") || l.getTipo().equals("A")) {

                        String v = formatar.format(l.getTaxa());
                        listaEmprestimo.add(l);
                        modelo.addRow(new Object[]{l.getNome(), v
                        });
                    }
                } else {

                    if (l.getTipo().equals("V") || l.getTipo().equals("A")) {

                        String v = formatar.format(l.getPreco());
                        listaVenda.add(l);
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/livro.png"))); // NOI18N
    ...
    private void botConfirmarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (linha == -1) {
            ...
            if (this.tipo == 0) {
                ...
                this.livro = listaEmprestimo.get(linha);

            } else {

                this.livro = listaVenda.get(linha);
