...
public class TelaVendedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setLayout(new java.awt.GridLayout(1, 8, 2, 0));
    ...
    private void botLivroActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (isGeneroCadastrado()) {
            ...
            JOptionPane.showMessageDialog(this, "Solicite ao administrador que cadastre gêneros.");
        }
    ...
    private void botVendaActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (ControleCaixa.getCaixaAberto() != null) {
    ...
    private void botCaixaActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (!ControleCaixa.isCaixaAberto()) {
            ...
            JOptionPane.showMessageDialog(this, "O caixa de hoje não foi aberto, solicite ao administrador a abertura.");
        } else {
    ...
    private void botGeneroActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        TelaGenero tela = new TelaGenero(null, true);
