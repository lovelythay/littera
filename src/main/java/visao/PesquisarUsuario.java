...
public class PesquisarUsuario extends javax.swing.JDialog {
    ...
    public PesquisarUsuario(java.awt.Frame parent, boolean modal) {
        ...
        tabUsuario.getColumnModel().getColumn(0).setPreferredWidth(350);
        tabUsuario.getColumnModel().getColumn(1).setPreferredWidth(200);
    ...
    private void atualizarTabela() {
        ...
        for (Usuario u : listaUsuario) {
            ...
            modelo.addRow(new Object[]{u.getNome(), tipo
            });
    ...
    private void initComponents() {
        ...
        setTitle("LITTERA - Pesquisar Usuário");
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/usuario.png"))); // NOI18N
    ...
    private void botConfirmarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (linha == -1) {
            ...
            this.usuario = listaUsuario.get(linha);
